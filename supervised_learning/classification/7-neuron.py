...
class Neuron:
    ...
    def train(self, X, Y, iterations=5000, alpha=0.05,
        ...
        Parameters:
            ...
            iterations (int): Number of iterations to train the neuron.
        ...
        Raises:
            ...
            ValueError: If alpha is not a positive float.

        Returns:
            tuple: The evaluation of the training data after
                training has completed, as a tuple (predictions, cost).
        """
