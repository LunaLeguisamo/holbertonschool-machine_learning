...
class Leaf(Node):
    ...
    def count_nodes_below(self, only_leaves=False):
        """
        Returns the count of nodes below this node (always 1 for a leaf).

        Args:
            only_leaves (bool): Ignored for leaf, always returns 1.
...
class Decision_Tree:
    ...
    def depth(self):
        """
        Calculates the depth of the entire tree.
    ...
    def count_nodes(self, only_leaves=False):
        ...
        Returns:
            int: Number of nodes or leaf nodes in the tree.
        """
